        ...
        <div class="container-fluid px-4 pt-4">
            <form action="{{ route('roles.update', $role->id) }}" method="post" id="roleForm">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h4 class="mb-1 fw-bold text-dark">Edit Role: {{ $role->name }}</h4>
                    ...
                    <div class="card-body p-4">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-text mt-2"><i class="ph ph-info me-1"></i> Role names cannot be changed
                                    once created.</div>
                            </div>
                        </div>
                    </div>
